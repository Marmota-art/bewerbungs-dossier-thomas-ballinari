      ...
      <main id="portal-content" className={`flex-grow flex flex-col max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full ${activeTab === "chatbot" ? "py-3" : "py-8"}`}>
        ...
        {activeTab === "testimonials" && (
          <TestimonialsPage
            ...
            onTestimonialSearchChange={setTestimonialSearch}
            filteredTestimonials={filteredTestimonials}
            selectedTestimonialId={selectedTestimonial}
            onSelectTestimonial={setSelectedTestimonial}
            activeTestimonial={activeTestimonialObj}
            onGoToResume={() => setActiveTab("resume")}
            renderDocumentLinks={renderDocumentLinks}
          />
        )}
