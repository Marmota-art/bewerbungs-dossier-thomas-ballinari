        ...
        {activeTab === "resume" && (
          <section id="sect-resume" className="space-y-12 animate-fade-in font-sans">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-4 border-b border-slate-900 text-left">
              <div className="space-y-1">
                <h2 className="text-3xl font-serif font-black text-white">Lebenslauf</h2>
                <p className="text-slate-400 text-sm font-light">
                  Beruflicher Werdegang, Ausbildung und Kompetenzen im interaktiven Dossier-Layout.
                </p>
              </div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-6 rounded-2xl bg-slate-900 border border-slate-800">
              ...
              <button
                onClick={() => setActiveTab("testimonials")}
                className="px-6 py-3 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 font-bold text-sm hover:bg-emerald-500/20 transition-all flex items-center gap-2 shrink-0"
              >
                <Award className="w-4 h-4" />
                <span>Arbeitszeugnisse ansehen</span>
              </button>
            </div>
          </section>
        )}

        {/* 3. ARBEITSZEUGNISSE (eigene Hauptseite) */}
          ...
          <section id="sect-testimonials" className="space-y-10 animate-fade-in font-sans">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-4 border-b border-slate-900 text-left">
              <div className="space-y-2 max-w-2xl">
                ...
                <p className="text-slate-400 text-sm font-light leading-relaxed">
                  Schweizer und internationale Arbeitgeber im originalen Wortlauf. Wähle ein Zeugnis links, lies den Volltext rechts oder lade die PDF-Sammlung herunter.
                </p>
              </div>
              <div className="flex flex-col sm:flex-row flex-wrap items-start sm:items-center gap-3">
                {renderDocumentLinks(
              ...
              <div className="lg:col-span-8">
                <div className="bg-slate-950 rounded-2xl border border-slate-850 overflow-hidden flex flex-col min-h-[520px] shadow-2xl">
                  ...
                  <div className="bg-emerald-500/[0.03] border-b border-slate-850/80 p-5 font-light text-xs sm:text-sm text-slate-300">
                    ...
                    <p className="italic leading-relaxed mt-1">&quot;{activeTestimonialObj.summary}&quot;</p>
                  </div>
                  ...
                  <div className="p-8 md:p-10 overflow-y-auto flex-1 max-h-[420px] bg-white text-slate-900 font-serif shadow-inner">
                    <div className="max-w-md mx-auto space-y-6 text-sm">
                      <div className="flex justify-between items-center border-b border-slate-150 pb-4 font-sans text-[10px] text-slate-400 uppercase tracking-wider">
                        <span>{activeTestimonialObj.employer}</span>
                        <span>{activeTestimonialObj.period}</span>
                      </div>
                      <h4 className="text-center font-sans font-black text-slate-900 text-lg border-b-2 border-slate-900 pb-1 uppercase tracking-tight">
                        {activeTestimonialObj.documentTitle || "ARBEITSZEUGNIS"}
                      </h4>
                      <p className="whitespace-pre-wrap leading-relaxed text-slate-800">
                        {activeTestimonialObj.fullText}
                      </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-4 text-xs font-semibold">
              ...
              <ul className="grid grid-cols-2 gap-2 text-slate-450 text-slate-450 text-slate-400">
                ...
                <li><button onClick={() => setActiveTab("testimonials")} className="hover:text-teal-300 text-left">Arbeitszeugnisse</button></li>
